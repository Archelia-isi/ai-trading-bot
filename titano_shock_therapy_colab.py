 ...
 "cells": [
  {
   ...
   "metadata": {},
   "source": [
    "# Titano V6 - Shock Therapy (Day Trader Edition)\n",
    "Esegui queste celle in sequenza."
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    ...
    "            if self.position == 1:\n",
    "                pnl_pct = (current_price - self.entry_price) / self.entry_price\n",
    "                if pnl_pct < 0: reward = pnl_pct * 200\n",
    "            elif self.position == -1:\n",
    "                pnl_pct = (self.entry_price - current_price) / self.entry_price\n",
    "                if pnl_pct < 0: reward = pnl_pct * 200\n",
    "        if self.position == 0:\n",
    "            market_move = abs(float(df['Returns'].iloc[self.current_step]))\n",
    "            if market_move > 0.005:\n",
    "                reward = -market_move * 300\n",
    "        self.current_step += 1\n",
    "        self.step_counter += 1\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "model.save(\"Titano_V6_DayTrader.zip\")\n",
    "print(\"Nuovo modello salvato. Scaricalo da Colab!\")\n"
   ]
  }
 ],
 "metadata": {
