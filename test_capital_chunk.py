...
# Try a small chunk: 12 hours of M1 data
from_time = "2026-06-05T00:00:00"
to_time = "2026-06-05T12:00:00"
epic = "US100"
...
if 'prices' in data:
    print(f"Success! Downloaded {len(data['prices'])} candles.")
    if len(data['prices']) > 0:
        print("First:", data['prices'][0]['snapshotTime'])
        print("Last:", data['prices'][-1]['snapshotTime'])
else:
    print("Error:", data)
